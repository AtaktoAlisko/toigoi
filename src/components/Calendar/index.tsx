...
export default function Calendar() {
  const [currentDate, setCurrentDate] = useState<Date>(new Date(2024, 7, 31)); // Set the correct month for August

  const weddingDate = new Date(2024, 7, 31); // Correct month for August
